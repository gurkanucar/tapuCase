...
class ShortUrlControllerTest extends IntegrationTestSupport {
    ...
    @Test
    public void testGetDetailByUserIdAndShortUrlId() throws Exception {
        ...
        //Get by userId and shortUrl id
        this.mockMvc.perform(get(SHORT_URL_CONTROLLER_BASE_URL + "/user/" + user.getId() + "/detail/" + shortUrl.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("$.id", is(shortUrl.getId().intValue())));
    ...
    @Test
    public void testDeleteByUserIdAndShortUrlId() throws Exception {
        ...
        //Get by userId and shortUrl id
        this.mockMvc.perform(delete(SHORT_URL_CONTROLLER_BASE_URL + "/user/" + user.getId() + "/detail/" + shortUrl.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("$.id", is(shortUrl.getId().intValue())));
